<template>
  <div :id="id" ref="dropdownCont" :class="{'relative': true}" >
      ...
      <transition name="dropdown-slide">
          <div v-if="isOpen" ref="dropdown" :style ="{ zIndex: zIndexValue }" class="absolute dropdown-body p-2 w-80 right-[50%] border-[#343437] top-12 mt-2 bg-[#1d1d20] rounded-md z-50" :class ="dropdownClass">
