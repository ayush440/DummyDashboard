<template>
    <!-- logo-topbar -->
    <div class="logo-topbar bg-white flex justify-between items-center relative p-2 pb-1">
        ...
        <div class="flex items-center">
            ...
            <div class="cursor-pointer ml-2 hover:bg-third-bold rounded-lg transition duration-200 dark:text-tableText" :class="{ 'rotate-0': !toggle, 'rotate-[180deg]': toggle }">
                <MenuIcon v-if="!toggle" class="m-2 w-6 h-6 transition transition-delay-300 hover:scale-110"  @click="toggle = !toggle, mobileToggle = !mobileToggle"/>
                <CloseIcon v-else @click="toggle = !toggle, mobileToggle = !mobileToggle" class="m-2 w-6 h-6  transition transition-delay-300 hover:scale-110" :class="{ 'rotate-0': toggle, 'rotate-[180deg]': !toggle }"/>
            </div>
        </div>
                            ...
                            <PopupDropdown :isOpen="showNotificationModal" @close="closeNotificationModal" dropdownClass ="dropdown-1 bg-secondary top-[100%] left-[5%] w-[230px] shadow-lg border border-secondary">
                                <template #dropdown-toggle>
                                    <div @click="toggleNotificationModal" class="unselectable flex flex-col cursor-pointer p-2 pt-4 pl-2">
                                        <div class = "flex items-center cursor-pointer font-semibold text-base">
