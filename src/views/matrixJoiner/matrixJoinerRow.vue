  ...
  <tr class="hidden sm:table-row intro-x">
    ...
    <td class="flex justify-center">
      <ButtonSwitch
        ...
        name="is_active"
        :modelValue="matrixJoiner.is_active"
        @update:modelValue="updateIsActive"
      />
    </td>
...
import { EditIcon, DeleteIcon, RightArrowIcon } from 'lucide-vue-next'
...
const handleActiveChange = async () => {
  await addEditMatrixJoiner(matrixJoiner.value.id, { is_active: !matrixJoiner.value.is_active })
}

const updateIsActive = (value: boolean) => {
  matrixJoiner.value.is_active = value
}
