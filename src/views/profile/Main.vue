<template>
  <div class=" md:ml-0 text-[#333333]"> 

    <div class="intro-y rounded flex items-center mt-2 dark:text-tableText ml-2 mr-2 sm:ml-4 sm:mr-4  ">
    ...
    <div>
      <!-- BEGIN: Profile Info -->
      <div class="intro-y rounded box px-5 pt-5 mt-5  ml-2 mr-2 sm:ml-4 sm:mr-4  ">
        <div
...
import Billing from "./billing.vue";
  ...
  .intro-y {
    @apply bg-white dark:bg-primary dark:border-none;
