<template>
    <div class="intro-x dark:text-white border shadow rounded box col-span-12 lg:col-span-6  ml-2 mr-2 sm:ml-4 sm:mr-4 ">
      <div class="flex items-center px-5 py-5 sm:py-3 border-b shadow dark:border-darkmode-400 ">
        ...
        <button class="btn  btn-primary" :class="{ 'opacity-60': isEditing }" @click="toggleEdit">
